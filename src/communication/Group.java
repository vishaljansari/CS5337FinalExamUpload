...
public class Group {
    ...
    public static final Group G99 = new Group("COMMAND_CENTER", "localhost", 53799,
            RoverDriveType.WALKER, RoverToolType.DRILL, RoverToolType.RADIATION_SENSOR);
    ...
    public static List<Group> getGatherers() {
        return filteredGroup(RoverToolType.DRILL, RoverToolType.RADIATION_SENSOR);
    }
}